...
\todo{add RW for other languages: Croatian, Slovene, Ukrainian, Slovak?}Prior work targeting NEs specifically
for Slavic languages includes a corpus of 11,000 manually annotated NEs
built for Czech~\cite{vsevvcikova2007named}, tools and resources for fine-grained annotation of NEs
in the National Corpus of Polish~\cite{was:etal:10,sav:pis:11} and a recent shared task on
...
\hline
{\em Scenario}      & {\bf Trump}     & \multicolumn{14}{c|}{\em Language}                                                                    \\
\hline
...
\hline
\multirow{3}{*}
{Coreference}       & Document level  & jhu      &  5.4 & jhu  &  7.3 & jhu  &  6.3 & jhu  & 11.2 & jhu  & 10.1 & jhu  &  9.5 & jhu  &  0.0   \\
\cline{2-16}
...
\hline
\hline
{\em Scenario}      & {\bf EU}        & \multicolumn{14}{c|}{\em Language}                                                                    \\
\hline
Phase               & Metric          & cz       &      & hr   &      & pl   &      & ru   &      & sk   &      & sl   &      & ua   &        \\
\hline
\multirow{6}{*}
...
\todo{Contact DeepNLP team, confirm description - they mentioned they
  might change the strategy slightly.  NO Results?}
