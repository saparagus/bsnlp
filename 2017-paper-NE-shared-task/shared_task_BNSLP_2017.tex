...
Another task related to cross-lingual NE recognition is a NE
transliteration, i.e. cross-lingual linking of NE across different
scripts. The series of NE Transliteration Shared Tasks as a part of
NEWS (Named Entity Workshops)~\cite{duan2016report}. These workshops
mostly focus on Indian and Asian languages. In 2010 NEWS Workshop
...
annotated 11 thousand manualy annotated NEs was built for the Czech
