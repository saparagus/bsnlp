...
Prior work targeting NEs specifically for Slavic languages includes tools for
NE recognition for Croatian \cite{karan2013croner,ljubesic2013combining}, a
tool specifically tailored for NE recognition in Croatian tweets
\cite{baksa2017tagging}, a manually annotated NE corpus for Croatian
\cite{agic2014setimes}, tools for NE recognition for Slovene
\cite{stajner2013razpoznavanje,ljubesic2013combining}, corpus of 11,000
manually annotated NEs built for Czech~\cite{vsevvcikova2007named} and NER
tools for Czech~\cite{Konkol:2013}, tools and resources for fine-grained
annotation of NEs in the National Corpus of
