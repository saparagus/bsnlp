...
\todo{Table 3 is confusing since it is not clear what are the respective metrics (we have more than 1 for various eval categories), and the figures do not fully correspond to the figures reported in the system papers submitted.}
